...
final class FileLogSink: @unchecked Sendable {
    ...
    static let defaultURL: URL = {
        ...
        return base
            ...
            .appendingPathComponent("SkillsBar", isDirectory: true)
            .appendingPathComponent("SkillsBar.log")
    }()

    private let queue = DispatchQueue(label: "com.skillsbar.filelog", qos: .utility)
