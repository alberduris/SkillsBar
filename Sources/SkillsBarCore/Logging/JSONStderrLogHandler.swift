...
struct JSONStderrLogHandler: LogHandler {
        ...
        line: UInt)
    {
        ...
        let redactedMessage = LogRedactor.redact(message.description)
        let redactedMetadata = combined.isEmpty ? nil : combined.mapValues { LogRedactor.redact($0.description) }
